      ...
      <ThemeContext.Provider value={getTheme(uiTheme)}>
        ...
        <View style={{ flex: 1 }}>
          ...
          this.props.navigation.getParam("mimeType") == "image/jpeg" && (
            <Image
              source={{ uri: this.props.navigation.getParam("filePath") }}
          ...
          <View style={styles.textFieldPadding}>
            <Button
              ...
              onPress={() =>
                this.uploadContent(
                  this.state.fileName,
                  this.props.navigation.getParam("filePathRaw"),
                  this.props.navigation.getParam("mimeType"),
                  this.props.navigation.getParam("fileExtension")
                )
              }
            />
            <Button
